...
import (
	...
	"example.com/inkkeep/internal/backup"
	"example.com/inkkeep/internal/model"
	"example.com/inkkeep/internal/policy"
	"example.com/inkkeep/internal/report"
	"example.com/inkkeep/internal/validate"
	"example.com/inkkeep/internal/workflow"
)
...
func (s *Server) handleBackup(w http.ResponseWriter, r *http.Request) {
	...
	w.Header().Set("Content-Disposition", "attachment; filename=inkkeep.zip")
	_, _ = w.Write(b)
}
